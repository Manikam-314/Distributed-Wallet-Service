            ...
            return (
              <div key={tx.id} className="flex items-center gap-4 p-4 bg-surface border border-border rounded-2xl active:scale-[0.98] transition-all cursor-pointer">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">{formatBackendDate(tx.timestamp).toLocaleString(undefined, { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit'})}</p>
                </div>
